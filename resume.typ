...
Master's Degree of Engineering #h(1fr) Toronto, ON, Canada
...
- Solid understanding of distributed systems fundamentals, including consensus algorithms (e.g., Raft) and consistency models.
...
Software Engineer Intern (Rust) #h(1fr) Beijing, China

- Collaborated with the infrastructure team to develop Lark Messenger's cross-platform Rust client backend.
- Responsible for the calendar component, introducing new features such as a new “create, edit and subscribe to calendars” experience.
...
Software Engineer Intern #h(1fr) Hangzhou, China
...
Software Engineer Intern (C++) #h(1fr) Beijing, China
...
- `Reddens`: A Metal renderer written in Swift.
